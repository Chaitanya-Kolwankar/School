...
public partial class Bonafide_Report : System.Web.UI.Page
{
                ...
                if (Session["stud_id"].ToString() != "" || Session["stud_id"].ToString()!=null)
               {
                ...
                using (var streamReader = new StreamReader(httpresponse.GetResponseStream()))
                {
                    ...
                    DateTime date = DateTime.ParseExact(dataSet.Tables["issue_bonafide"].Rows[0]["dob"].ToString(), "dd/MM/yyyy", null);
                        ...
                        lblstandard.Text = dataSet.Tables["issue_bonafide"].Rows[0]["class_id"].ToString().ToUpper();
                   
                   // DateTime issuedate = DateTime.ParseExact(dataSet.Tables["issue_bonafide"].Rows[0]["issue_dt"].ToString(), "dd-MM-yyyy", null);
                   // lbl_dt.Text = ( Date.ParseExact(dataSet.Tables["issue_bonafide"].Rows[0]["issue_dt"].ToString(), "dd-MM-yyyy", null)).ToString();
                   lbl_dt.Text = dataSet.Tables["issue_bonafide"].Rows[0]["issue_dt"].ToString();
                    ...
                    lbl_dob_wrds.Text = convertdatetowrds(date).ToUpper();

                    lblcast.Text = dataSet.Tables["issue_bonafide"].Rows[0]["cast_name"].ToString().ToUpper();
                    if (dataSet.Tables["issue_bonafide"].Rows[0]["other_std"].ToString() != "--")
                    {
                    ...
                    if (dataSet.Tables["issue_bonafide"].Rows[0]["student_photo"].ToString()!="")
                    {
                        ...
                        //imgphoto.ImageUrl = "~" + dt.Rows[0]["stud_photo"].ToString().Replace("\\", "/");
                    }
                    else
                    {
                        studentimg.ImageUrl = "~/image/user.png" ;
                    ...
                    //lblsaral.Text = dataSet.Tables["issue_bonafide"].Rows[0]["saral_id"].ToString();
                    ...
                    //lblmonth.Text = dataSet.Tables["issue_bonafide"].Rows[0]["month"].ToString().ToUpper();
                    //lblyear.Text = dataSet.Tables["issue_bonafide"].Rows[0]["year"].ToString();
                    ...
                    if (dataSet.Tables["issue_bonafide"].Rows[0]["std_name"].ToString().Contains("1"))
                    {
                        lblstandard.Text = "st.";
                    }
                    else if (dataSet.Tables["issue_bonafide"].Rows[0]["std_name"].ToString().Contains("2"))
                    {
                        lblstandard.Text = "nd.";
                    }
                    else if (dataSet.Tables["issue_bonafide"].Rows[0]["std_name"].ToString().Contains("3"))
                    {
                        lblstandard.Text = "rd.";
                    }
                    else
                    ...
                    {
                        //lbltext.Text = "passed the S.S.C /  examination  held in ";
                        //lblmonth.Visible = true;
                        //lblyear.Visible = true;
                        //lbltext2.Text = "in the first attempt.";
                    }
                    else
                    {
                        lblshe_he5.Visible = false;
                        //lbltext.Text = "";
